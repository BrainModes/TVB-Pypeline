...
@profile
def profile_me(SC_cap_agg_tmp, SC_dist_agg_tmp, SC_cap_agg_counts, SC_cap_agg_bwflav1, SC_cap_agg_bwflav2, SC_dist_agg, steplength):
    theKeys = SC_cap_agg_tmp.keys()
    #for key in range(len(theKeys)):
    for key in range(10):
        seedVoxelID = theKeys[key]
        #print(str(key) + ' / ' + str(len(theKeys)))
        ...
        #print('Inserting stuff for the following No. of target-regions: ' + str(len(targetRegionIDs)))
    ...
    return SC_cap_agg_tmp, SC_dist_agg_tmp, SC_cap_agg_counts, SC_cap_agg_bwflav1, SC_cap_agg_bwflav2, SC_dist_agg
...
SC_cap_agg_tmp, SC_dist_agg_tmp, SC_cap_agg_counts, SC_cap_agg_bwflav1, SC_cap_agg_bwflav2, SC_dist_agg = profile_me(SC_cap_agg_tmp, SC_dist_agg_tmp, SC_cap_agg_counts, SC_cap_agg_bwflav1, SC_cap_agg_bwflav2, SC_dist_agg, steplength)
