...
def gen_default_feat_config(bold_folder, bold_file, brainmask_file, standard_T1_brain, numVox, numVol):
    ...
    # Output directory
    set fmri(outputdir) "''' + bold_folder + '''/featDir"

    # TR(s)
    set fmri(tr) 1.940000

    # Total volumes
    set fmri(npts) ''' + str(numVol) + '''
    ...
    # Standard image
    set fmri(regstandard) "''' + standard_T1_brain + '''"
    ...
    # Total voxels
    set fmri(totalVoxels) ''' + str(numVox) + '''
    ...
    set feat_files(1) "''' + bold_file + '''"

    # Add confound EVs text file
    set fmri(confoundevs) 0

    # Session's structural image for analysis 1
    set initial_highres_files(1) "''' + brainmask_file + '''"

    # Subject's structural image for analysis 1
    set highres_files(1) "''' + brainmask_file + '''"
